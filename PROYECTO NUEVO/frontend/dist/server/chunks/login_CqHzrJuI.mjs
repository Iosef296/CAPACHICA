import { _ as __variableDynamicImportRuntimeHelper, A as APP_CONFIG, $ as $$GastronomiaLayout, r as renderScript } from './app.config_DAtNSecO.mjs';
import { c as createComponent } from './astro-component_D4_SZq4w.mjs';
import { p as renderComponent, h as renderTemplate, m as maybeRenderHead, g as addAttribute } from './server_9i1cpG6S.mjs';
...
</p> </div> ` })} ${renderScript($$result, "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend/src/pages/auth/login.astro?astro&type=script&index=0&lang.ts")}`;
}, "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend/src/pages/auth/login.astro", void 0);

const $$file = "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend/src/pages/auth/login.astro";

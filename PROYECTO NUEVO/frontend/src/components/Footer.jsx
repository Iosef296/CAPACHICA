...
const styles = `
 ...
 .cap-footer {
  ...
  .cap-contact-item { display: flex; align-items: center; gap: 6px; font-size: 12px; color: var(--cap-muted); }
            ...
            <div>
              ...
              <div className="cap-contact-row">
                ...
                <div className="cap-contact-item">
                  ...
                  <span>hola@capachicaturismo.pe</span>
                </div>
              </div>
            </div>
          </div>

        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <a href="/festividades" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gold-500 transition-colors">Festividades</a>
              <a href="/festividades/calendario" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gold-500 transition-colors">Calendario</a>
              <a href="/admin" className="text-sm text-gray-500 dark:text-gray-400 hover:text-gold-500 transition-colors">Administrar</a>
            </div>
          </div>
          <div>

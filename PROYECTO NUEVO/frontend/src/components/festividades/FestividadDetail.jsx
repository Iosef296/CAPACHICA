...
import { getFestividad } from '../../services/festividades.api.js';

export default function FestividadDetail({ id }) {
  ...
  if (!festividad) return (
    <div className="pt-24 min-h-screen flex flex-col items-center justify-center bg-white dark:bg-night-950">
      ...
      <a href="/festividades" className="text-gold-500 hover:underline">Volver a festividades</a>
    </div>
  );
  ...
  return (
    <div className="pt-20 pb-16 min-h-screen bg-white dark:bg-night-950 transition-colors duration-300">
      <div className="max-w-5xl mx-auto px-4">
        <a href="/festividades" className="inline-flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 hover:text-gold-500 mb-6 transition-colors">
          ...
          <div>
            <div className="p-6 rounded-2xl bg-gray-50 dark:bg-night-800 border border-gray-200 dark:border-night-700 sticky top-24">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200 dark:border-night-700">
                <a href="/festividades/calendario" className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-gold-500 hover:bg-gold-600 text-black font-semibold text-sm transition-all"><Calendar size={16} />Ver en Calendario</a>
              </div>
            </div>
          </div>
        </div>

  ...
  return (
    <div className="card-festividad rounded-2xl bg-white dark:bg-night-800 border border-gray-200 dark:border-night-700 overflow-hidden group">
      ...
      <div className="p-5">
        ...
        <a href={`/festividades/${festividad.id}`} className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl bg-gold-500 hover:bg-gold-600 text-black font-semibold text-sm transition-all duration-300 group-hover:shadow-lg group-hover:shadow-gold-500/20">

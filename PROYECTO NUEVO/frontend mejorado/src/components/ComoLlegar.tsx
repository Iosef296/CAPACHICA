...
export default function ComoLlegar() {
  ...
  const calcularRuta = () => {
    ...
    if (origenLower.includes("lima")) setRutaActiva("aire");
      ...
      origenLower.includes("cusco") ||
      origenLower.includes("arequipa") ||
      origenLower.includes("paz")
    )
      setRutaActiva("bus");
  ...
  return (
    <>
      ...
      <section className="llegar-section llegar-bg">
        <div className="container">
          <div className="calculadora">
            ...
            >
              🗺️ Calculadora de Ruta
            </h2>
            <p className="sec-muted" style={{ fontSize: 14, marginBottom: 24 }}>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              ...
              />
              <button onClick={calcularRuta} className="btn-primary">
                Ver ruta →
              </button>
            </div>
          </div>
          ...
          {rutaSeleccionada && (
            <div>
              ...
              >
                ...
                >
                  {rutaSeleccionada.icon} {rutaSeleccionada.titulo}
                </h3>
              ...
              >
                {rutaSeleccionada.opciones.map((op, i) => (
                  <div key={i} className="opcion-card">
      ...
      {/* MAPA */}
      <section className="llegar-section llegar-bg2">
        <div className="container">
        ...
        <div className="container">
          ...
          <div className="transportistas-grid">
            {transportistas.map((t, i) => (
              <div key={i} className="transportista-card">

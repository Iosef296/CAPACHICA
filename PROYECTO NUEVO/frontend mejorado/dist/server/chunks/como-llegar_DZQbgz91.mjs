...
import 'piccolore';
import { o as renderComponent, h as renderTemplate, q as Fragment$1, m as maybeRenderHead } from './server_80AW_iNR.mjs';
...
function ComoLlegar({ hideHero = false }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("style", { children: `
      ...
      ` }),
    !hideHero && /* @__PURE__ */ jsx("section", { className: "llegar-hero", children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
      /* @__PURE__ */ jsx("span", { className: "badge badge-cyan", style: { marginBottom: 20, display: "inline-block" }, children: "CÓMO LLEGAR · CAPACHICA" }),
      /* @__PURE__ */ jsxs("h1", { style: { fontFamily: "var(--font-display)", lineHeight: 0.95 }, children: [
        /* @__PURE__ */ jsx("span", { className: "sec-title", style: { display: "block", fontSize: "clamp(42px,7vw,80px)", fontWeight: 700 }, children: "Planifica tu" }),
        /* @__PURE__ */ jsx("span", { className: "gold", style: { display: "block", fontSize: "clamp(38px,6.5vw,72px)", fontStyle: "italic", fontWeight: 400 }, children: "Viaje" })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "sec-text", style: { marginTop: 20, fontSize: 16, maxWidth: 500, margin: "20px auto 0", lineHeight: 1.7 }, children: "Cuentanos tu sueño y lo hacemos realidad. Respondemos en 24 horas." })
    ] }) }),
...
const $$ComoLlegar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Cómo Llegar — Capachica" }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "ComoLlegar", ComoLlegar, { "client:load": true, "hideHero": true, "client:component-hydration": "load", "client:component-path": "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend mejorado/src/components/ComoLlegar", "client:component-export": "default" })} `, "hero": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment$1, { "slot": "hero" }, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<span class="section-label">CÓMO LLEGAR · CAPACHICA</span> <h1 style="font-family:var(--font-display);font-size:clamp(3rem,7vw,5.5rem);line-height:1.05;color:var(--text-main);margin-bottom:0.4rem;">
Planifica tu
</h1> <h1 style="font-family:var(--font-display);font-size:clamp(2.6rem,6.5vw,5rem);font-style:italic;font-weight:400;color:var(--gold);line-height:1.05;margin-bottom:1.2rem;">
Viaje
</h1> <p style="font-size:clamp(1rem,2vw,1.1rem);color:var(--text2);max-width:480px;margin:0 auto 2rem;line-height:1.7;">
Cuéntanos tu sueño y lo hacemos realidad. Respondemos en 24 horas.
</p> ` })}` })}`;

...
const $$Vivencial = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Turismo Vivencial — Capachica" }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "VivencialTimeline", VivencialTimeline, { "client:load": true, "client:component-hydration": "load", "client:component-path": "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend mejorado/src/components/VivencialTimeline", "client:component-export": "default" })} ${renderComponent($$result2, "FamiliasGrid", FamiliasGrid, { "client:load": true, "client:component-hydration": "load", "client:component-path": "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend mejorado/src/components/FamiliasGrid", "client:component-export": "default" })} ${renderComponent($$result2, "ReservaForm", ReservaForm, { "client:load": true, "client:component-hydration": "load", "client:component-path": "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend mejorado/src/components/ReservaForm", "client:component-export": "default" })} `, "hero": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment$1, { "slot": "hero" }, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<span class="section-label">VIVENCIAL · CAPACHICA · 3,820 MSNM</span> <h1 style="font-family:var(--font-display);font-size:clamp(3rem,7vw,5.5rem);line-height:1.05;color:var(--text-main);margin-bottom:0.4rem;">
Turismo
...
Vivencial
</h1> <p style="font-size:clamp(1rem,2vw,1.15rem);color:var(--text2);max-width:480px;margin:0 auto 2rem;line-height:1.7;">
Más que turismo: una inmersión real en la vida andina de las familias de Capachica, a orillas del Titicaca.
</p> <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap;"> <a href="#familias" class="btn-primary">Ver familias →</a> <a href="#reservar" class="btn-outline">Reservar ahora</a> </div> ` })}` })}`;

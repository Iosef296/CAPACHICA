...
function ArtesaniaPage({ hideHero = false }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("style", { children: `
      ...
      ` }),
    !hideHero && /* @__PURE__ */ jsx("section", { className: "artesania-hero", id: "artesania", children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
      ...
      /* @__PURE__ */ jsxs("h1", { style: { fontFamily: "var(--font-display)", lineHeight: 0.95 }, children: [
        /* @__PURE__ */ jsx("span", { className: "sec-title", style: { display: "block", fontSize: "clamp(42px,7vw,80px)", fontWeight: 700 }, children: t?.artesania?.titulo || "Artesanía" }),
        /* @__PURE__ */ jsx("span", { className: "art-gold", style: { display: "block", fontSize: "clamp(38px,6.5vw,72px)", fontStyle: "italic", fontWeight: 400 }, children: t?.artesania?.subtitulo || "Capachiqueña" })
      ] }),
      /* @__PURE__ */ jsx("p", { className: "sec-text", style: { marginTop: 20, fontSize: 16, maxWidth: 500, margin: "20px auto 0", lineHeight: 1.7 }, children: t?.artesania?.descripcion || "Artesanía tradicional de Capachica" })
    ] }) }),
...
const $$Artesania = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Artesanía — Capachica" }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "Artesania", ArtesaniaPage, { "client:load": true, "hideHero": true, "client:component-hydration": "load", "client:component-path": "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend mejorado/src/components/Artesania", "client:component-export": "default" })} `, "hero": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment$1, { "slot": "hero" }, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<span class="section-label">ARTESANÍA · CAPACHICA</span> <h1 style="font-family:var(--font-display);font-size:clamp(3rem,7vw,5.5rem);line-height:1.05;color:var(--text-main);margin-bottom:0.4rem;">
Artesanía

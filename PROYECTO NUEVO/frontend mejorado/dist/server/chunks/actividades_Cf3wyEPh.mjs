...
import { $ as $$ArenaFooter } from './ArenaFooter_PlKcgS9w.mjs';
/* empty css                 */
...
S/.<span id="modalPrice">0</span> <span style="font-size:0.8rem;color:rgba(240,237,232,0.5);">/persona</span> </span> </div> <button class="btn-submit" onclick="submitReserva()">Confirmar reserva →</button> </div> </div> <script>
  ...
  <\/script> </body> </html>`])), renderHead(), renderComponent($$result, "Navbar", Navbar, { "client:load": true, "client:component-hydration": "load", "client:component-path": "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend mejorado/src/components/Navbar", "client:component-export": "default" }), renderComponent($$result, "ArenaFooter", $$ArenaFooter, {}));

import { A as AstroError, N as NoImageMetadata, U as UnsupportedImageFormat, w as MissingSharp } from './server_9i1cpG6S.mjs';
import { b as baseService, d as detector, r as resolveDefaultOutputFormat, p as parseQuality } from './node_CIiQvMjr.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_ChcRbgnp.mjs').then(n => n.i)).default;
  } catch {

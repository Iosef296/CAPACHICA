...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("nav", { style: {
      ...
      right: 0,
      zIndex: 100,
      background: scrolled || menuOpen ? dark ? "rgba(6,15,26,0.75)" : "rgba(13,71,161,0.35)" : "transparent",
      ...
      borderBottom: scrolled || menuOpen ? `1px solid rgba(56,189,248,${dark ? "0.12" : "0.2"})` : "1px solid transparent",
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("a", { href: "/", style: { display: "flex", alignItems: "center", gap: 10, textDecoration: "none", flexShrink: 0 }, children: [
          /* @__PURE__ */ jsx("div", { style: {
            width: 36,
            height: 36,
            borderRadius: "50%",
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { style: { fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 15, color: "rgba(240,237,232,0.95)", lineHeight: 1 }, children: "Capachica" }),
            /* @__PURE__ */ jsx("div", { style: { fontSize: 9, color: "rgba(240,237,232,0.50)", letterSpacing: "0.14em", textTransform: "uppercase" }, children: "Turismo Vivencial" })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "nav-desktop", style: { display: "flex", gap: 1, flex: 1, justifyContent: "center" }, children: navLinks.map((l) => /* @__PURE__ */ jsx("a", { href: l.href, className: `nav-link${isActive(l.href) ? " active" : ""}`, children: l.label }, l.href)) }),
      ...
      menuOpen && /* @__PURE__ */ jsx("div", { className: "mobile-menu", style: {
        padding: "10px 0 18px",

...
function AdminPanel() {
  ...
  const [iaData, setIaData] = useState({ conocimiento: [], contexto_base: "", nombre_ia: "Inti" });
  ...
  const loadIA = useCallback(async () => {
    ...
    try {
      ...
      showMsg("Error al cargar conocimiento IA", "err");
    }
    setIaLoading(false);
  }, []);
  useEffect(() => {
  ...
  const addEntry = async () => {
    if (!iaEntry.pregunta.trim() || !iaEntry.respuesta.trim()) {
      showMsg("Pregunta y Respuesta son obligatorias", "err");
      return;
    }
    try {
  ...
  const saveContexto = async () => {
    try {
      ...
      showMsg("Error al guardar contexto", "err");
    }
  };
  const inputStyle = {
    width: "100%",
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "admin-section", children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
      ...
      tab === "ia" && /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24, flexWrap: "wrap", gap: 12 }, children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h2", { className: "sec-title", style: { fontFamily: "var(--font-display)", fontSize: 22 }, children: "🤖 Conocimiento de Inti" }),
            /* @__PURE__ */ jsxs("p", { className: "sec-muted", style: { fontSize: 12, marginTop: 4 }, children: [
              iaData.conocimiento.length,
              " entradas · IA Backend: ",
              IA_URL
            ] })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 8 }, children: [
            /* @__PURE__ */ jsx("button", { onClick: () => setShowCtx((c) => !c), className: "btn-outline", style: { fontSize: 12, padding: "8px 14px" }, children: showCtx ? "Ocultar contexto" : "✏️ Editar contexto base" }),
            /* @__PURE__ */ jsx("button", { onClick: loadIA, className: "btn-outline", style: { fontSize: 12, padding: "8px 14px" }, children: "🔄" })
          ] })
        ] }),
        showCtx && /* @__PURE__ */ jsxs("div", { className: "admin-card", style: { marginBottom: 24 }, children: [
          /* @__PURE__ */ jsx("p", { className: "sec-muted", style: { fontSize: 12, marginBottom: 8 }, children: "Contexto base del sistema — instrucciones globales que Inti siempre sigue" }),
          /* @__PURE__ */ jsx(
            "textarea",
            {
              value: editCtx,
          ...
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 10, marginTop: 12 }, children: [
            /* @__PURE__ */ jsx("button", { onClick: saveContexto, className: "btn-primary", style: { fontSize: 13 }, children: "💾 Guardar contexto" }),
            /* @__PURE__ */ jsx("button", { onClick: () => {
              setEditCtx(iaData.contexto_base);
              setShowCtx(false);
            }, className: "btn-outline", style: { fontSize: 13 }, children: "Cancelar" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "admin-card", style: { marginBottom: 28 }, children: [
          /* @__PURE__ */ jsx("h3", { className: "sec-title", style: { fontSize: 16, marginBottom: 16 }, children: "+ Agregar nuevo conocimiento" }),
          /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 2fr 2fr", gap: 12, alignItems: "end" }, children: [
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { style: { fontSize: 11, color: "#7f95aa", display: "block", marginBottom: 5 }, children: "Categoría" }),
              /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx("option", { value: "precios", children: "precios" }),
                    /* @__PURE__ */ jsx("option", { value: "actividades", children: "actividades" }),
                    /* @__PURE__ */ jsx("option", { value: "alojamiento", children: "alojamiento" }),
                    /* @__PURE__ */ jsx("option", { value: "transporte", children: "transporte" }),
                    /* @__PURE__ */ jsx("option", { value: "gastronomia", children: "gastronomía" }),
                    /* @__PURE__ */ jsx("option", { value: "cultura", children: "cultura" }),
                    /* @__PURE__ */ jsx("option", { value: "clima", children: "clima" }),
                    /* @__PURE__ */ jsx("option", { value: "reservas", children: "reservas" })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { style: { fontSize: 11, color: "#7f95aa", display: "block", marginBottom: 5 }, children: "Pregunta *" }),
              /* @__PURE__ */ jsx(
                "input",
                {
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("label", { style: { fontSize: 11, color: "#7f95aa", display: "block", marginBottom: 5 }, children: "Respuesta *" }),
              /* @__PURE__ */ jsx(
                "input",
                {
          ...
          /* @__PURE__ */ jsx("button", { onClick: addEntry, className: "btn-primary", style: { marginTop: 14, fontSize: 13 }, children: "+ Agregar a Inti" })
        ] }),
        ...
        iaLoading && /* @__PURE__ */ jsx("p", { className: "sec-muted", children: "Cargando..." }),
        !iaLoading && /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
          iaData.conocimiento.filter((k) => !iaSearch || k.pregunta.toLowerCase().includes(iaSearch.toLowerCase()) || k.respuesta.toLowerCase().includes(iaSearch.toLowerCase()) || k.categoria.toLowerCase().includes(iaSearch.toLowerCase())).map((k) => /* @__PURE__ */ jsxs("div", { className: "admin-card", style: { display: "flex", gap: 16, alignItems: "flex-start" }, children: [
            ...
            /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
              /* @__PURE__ */ jsx("div", { style: { color: "#f4f7fb", fontWeight: 600, fontSize: 14, marginBottom: 4 }, children: k.pregunta }),
              /* @__PURE__ */ jsx("div", { className: "sec-muted", style: { fontSize: 13, lineHeight: 1.55 }, children: k.respuesta })
            ] }),
            /* @__PURE__ */ jsx(
              "button",
              {
          ...
          iaData.conocimiento.length === 0 && /* @__PURE__ */ jsx("p", { className: "sec-muted", children: "No hay entradas de conocimiento aún. Agrega la primera arriba." })
        ] })
      ] })
    ] }) }),
...
const $$Admin = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Admin Dashboard — Capachica" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "AdminPanel", AdminPanel, { "client:load": true, "client:component-hydration": "load", "client:component-path": "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend mejorado/src/components/AdminPanel", "client:component-export": "default" })} ` })}`;
}, "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend mejorado/src/pages/admin.astro", void 0);

const $$file = "F:/SISTEMAS/CAPACHICA/PROYECTO NUEVO/frontend mejorado/src/pages/admin.astro";
const $$url = "/admin";

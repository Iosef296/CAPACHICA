...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs("nav", { style: {
      ...
      right: 0,
      zIndex: 100,
      background: scrolled || menuOpen ? dark ? "rgba(6,15,26,0.92)" : "rgba(230,243,252,0.94)" : "transparent",
      ...
      /* @__PURE__ */ jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxs("a", { href: "/", style: { display: "flex", alignItems: "center", gap: 10, textDecoration: "none", flexShrink: 0 }, children: [
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("div", { style: { fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 15, color: "var(--text)", lineHeight: 1 }, children: "Capachica" }),
            /* @__PURE__ */ jsx("div", { style: { fontSize: 9, color: "var(--text3)", letterSpacing: "0.14em", textTransform: "uppercase" }, children: "Turismo Vivencial" })
          ] })
        ] }),
